---
title: "Claude Code, Without Leaving the Terminal"
published: false
description: "Branch, merge request, pipeline, context and both rate limits on one line."
tags: claude, cli, bash, productivity
---

*Branch, merge request, pipeline, context and both rate limits on one line.*

<!-- UPLOAD: blog/images/banner.png — alt: "statusline-hud v2" -->

<!-- UPLOAD: blog/images/statusline-hud.png — alt: "The default bar: git branch, GitLab MR !23 mergeable, a green pipeline dot, Sonnet 5 at high effort with thinking on, and the context, 5h and 7d bars" -->
...
Claude Code does surface some of this info. But I tended to dismiss them without reading.
---
...
`bash statusline-hud.sh --demo` shows you the whole thing before you wire anything. Manual install and every setting are in the **[README](https://github.com/newell-paul/statusline-hud)**.
